...
type DeinRufzeichenState = {
    ...
    availableCallsigns: { n: string[]; e: string[]; a: string[] };
    setAvailableCallsigns: (callsigns: { n: string[]; e: string[]; a: string[] }) => void;
};
...
export const useStore = create<DeinRufzeichenState>((set) => ({
    ...
    availableCallsigns: { n: [], a: [], e: [] },
    setAvailableCallsigns: (callsigns: { n: string[]; e: string[]; a: string[] }) =>
        set({ availableCallsigns: callsigns }),
}));
